...
# I have some kind of logging here, and the secret is the enviornent
# Configure logging
...
@app.route("/flag")
def flag():
    # Here we want to see if he is admin. So our goal is to privesc
