...
class WP_LaTeX_Admin extends WP_LaTeX
{
	...
	{
		?>
		<div id="latex-chmod" class="error fade">
			<p>
				<?php printf(
	...
	{
		?>
		<div id="latex-config" class="updated fade">
			<p>
				<?php printf(
	...
	function admin_page()
	{
		...
		if ($errors = $this->errors->get_error_codes()):
			...
			?>
						...
						<div class='wrap'>
								<h2>
										<?php _e('WP LaTeX Options', 'wp-latex'); ?>
								</h2>
								...
								<form action="<?php echo esc_url(remove_query_arg('updated')); ?>" method="post">
														...
														<?php if (empty($errors)): ?>
																	<tr>
																			...
																			<td class="syntax">
																					...
																					<p>
																							<?php _e('For more information, see the <a href="http://wordpress.org/extend/plugins/wp-latex/faq/">FAQ</a>'); ?>
																					</p>
																			</td>
																	</tr>
														<?php endif; ?>
														<tr<?php if (in_array('method', $errors))
															echo ' class="form-invalid"'; ?>>
																<th scope="row">
																		<?php _e('LaTeX generation method', 'wp-latex'); ?>
																</th>
																<td>
																		<ul id="wp-latex-method-switch">
																				<li><label for="wp-latex-method-wpcom"><input type="radio" name="wp_latex[method]"
																										id="wp-latex-method-wpcom" value='Automattic_Latex_WPCOM' <?php checked('Automattic_Latex_WPCOM', $values['method']); ?> />
																								<?php printf(_x('%s LaTeX server (recommended)', 'WordPress.com LaTeX Server (recommended)', 'wp-latex'), '<a href="http://wordpress.com/" target="_blank">WordPress.com</a>'); ?>
																						</label></li>
																				<li><label for="wp-latex-method-dvipng"><input type="radio" name="wp_latex[method]"
																										id="wp-latex-method-dvipng" value='Automattic_Latex_DVIPNG' <?php checked('Automattic_Latex_DVIPNG', $values['method']); ?> />
																								<?php _e('Local LaTeX installation using <code>dvipng</code>', 'wp-latex'); ?>
																						</label></li>
																				<li><label for="wp-latex-method-dvips"><input type="radio" name="wp_latex[method]"
																										id="wp-latex-method-dvips" value='Automattic_Latex_DVIPS' <?php checked('Automattic_Latex_DVIPS', $values['method']); ?> />
																								<?php _e('Local LaTeX installation using <code>dvips</code> and <code>convert</code>', 'wp-latex'); ?>
																						</label></li>
																		</ul>
																</td>
																</tr>
																...
																<tr
																		class="wp-latex-method wp-latex-method-dvipng wp-latex-method-dvips<?php if (in_array('latex_path', $errors))
																			echo ' form-invalid'; ?>">
																		<th scope="row"><label for="wp-latex-latex-path">
																						<?php _e('<code>latex</code> path'); ?>
																				</label></th>
																		<td><input type='text' name='wp_latex[latex_path]'
																						value='<?php echo esc_attr($values['latex_path']); ?>' id='wp-latex-latex-path' />
																				<?php
																...
																<tr
																		class="wp-latex-method wp-latex-method-dvipng<?php if (in_array('dvipng_path', $errors))
																			echo ' form-invalid'; ?>">
																		<th scope="row"><label for="wp-latex-dvipng-path">
																						<?php _e('<code>dvipng</code> path'); ?>
																				</label></th>
																		<td><input type='text' name='wp_latex[dvipng_path]'
																						value='<?php echo esc_attr($values['dvipng_path']); ?>' id='wp-latex-dvipng-path' />
																				<?php
																...
																<tr
																		class="wp-latex-method wp-latex-method-dvips<?php if (in_array('dvips_path', $errors))
																			echo ' form-invalid'; ?>">
																		<th scope="row"><label for="wp-latex-dvips-path">
																						<?php _e('<code>dvips</code> path'); ?>
																				</label></th>
																		<td><input type='text' name='wp_latex[dvips_path]'
																						value='<?php echo esc_attr($values['dvips_path']); ?>' id='wp-latex-dvips-path' />
																				<?php
																...
																<tr
																		class="wp-latex-method wp-latex-method-dvips<?php if (in_array('convert_path', $errors))
																			echo ' form-invalid'; ?>">
																		<th scope="row"><label for="wp-latex-convert-path">
																						<?php _e('<code>convert</code> path', 'wp-latex'); ?>
																				</label></th>
																		<td><input type='text' name='wp_latex[convert_path]'
																						value='<?php echo esc_attr($values['convert_path']); ?>' id='wp-latex-convert-path' />
																				<?php
																...
																<tr<?php if (in_array('fg', $errors))
																	echo ' class="form-invalid"'; ?>>
																		<th scope="row"><label for="wp-latex-fg">
																						<?php _e('Default text color', 'wp-latex'); ?>
																				</label></th>
																		<td>
																				<input type='text' name='wp_latex[fg]' value='<?php echo esc_attr($values['fg']); ?>'
																						id='wp-latex-fg' />
																				<?php _e('A six digit hexadecimal number like <code>000000</code> or <code>ffffff</code>'); ?>
																		</td>
																		</tr>
																		<tr<?php if (in_array('bg', $errors))
																			echo ' class="form-invalid"'; ?>>
																				<th scope="row"><label for="wp-latex-bg">
																								<?php _e('Default background color', 'wp-latex'); ?>
																						</label></th>
																				<td>
																						<input type='text' name='wp_latex[bg]' value='<?php echo esc_attr($values['bg']); ?>'
																								id='wp-latex-bg' />
																						<?php _e('A six digit hexadecimal number like <code>000000</code> or <code>ffffff</code>, or <code>transparent</code>'); ?>
																				</td>
																				</tr>
																				<tr>
																						<th scope="row"><label for='wp-latex-comments'>
																										<?php _e('Comments', 'wp-latex'); ?>
																								</label></th>
																						<td>
																				...
																				<tr>
																						<th scope="row"><label for="wp-latex-css">
																										<?php _e('Custom CSS to use with the LaTeX images', 'wp-latex'); ?>
																								</label></th>
																						<td>
																								<textarea name='wp_latex[css]' id='wp-latex-css' rows="8"
																										cols="50"><?php echo esc_textarea($values['css']); ?></textarea>
																						</td>
																				</tr>

																				<tr
																						class="wp-latex-method wp-latex-method-dvipng wp-latex-method-dvips<?php if (in_array('wrapper', $errors))
																							echo ' form-invalid     '; ?>">
																						<th scope="row"><label for="wp-latex-wrapper">
																										<?php _e('LaTeX Preamble', 'wp-latex'); ?>
																								</label></th>
																						<td>
																								<textarea name='wp_latex[wrapper]' rows='8' cols="50"
																										id='wp-latex-wrapper'><?php echo esc_textarea($values['wrapper']); ?></textarea>
																						</td>
																				</tr>
										...
										<p class="submit">
												<input type="submit" class="button-primary"
														value="<?php echo esc_attr(__('Update LaTeX Options', 'wp-latex')); ?>" />
