...
/* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/tomcat-embed-core-9.0.35.jar:org/apache/naming/NamingContextBindingsEnumeration.class */
public class NamingContextBindingsEnumeration implements NamingEnumeration<Binding> {
    ...
    /* renamed from: next */
    public Binding m790next() throws NamingException {
    ...
    public Binding m791nextElement() {
        try {
            return nextElementInternal();
