...
/* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/tomcat-embed-core-9.0.35.jar:org/apache/catalina/manager/HTMLManagerServlet.class */
public final class HTMLManagerServlet extends ManagerServlet {
    ...
    protected void list(HttpServletRequest request, HttpServletResponse response, String message, StringManager smClient) throws IOException {
        ...
        for (String contextName : contextNames) {
            ...
            if (ctxt != null) {
                ...
                args2[0] = "<a href=\"" + URLEncoder.DEFAULT.encode(contextPath + "/", StandardCharsets.UTF_8) + "\" rel=\"noopener noreferrer\">" + Escape.htmlElementContent(displayPath) + "</a>";
    ...
    protected Comparator<Session> getComparator(String sortBy) {
        ...
        } else if (LocaleChangeInterceptor.DEFAULT_PARAM_NAME.equalsIgnoreCase(sortBy)) {
