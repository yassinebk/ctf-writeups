...
/* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/tomcat-embed-core-9.0.35.jar:org/apache/catalina/manager/JMXProxyServlet.class */
    ...
    private Object invokeOperationInternal(String onameStr, String operation, String[] parameters) throws OperationsException, MBeanException, ReflectionException {
        ...
        if (null == methodInfo) {
            try {
                ...
                throw new IllegalArgumentException(sm.getString("jmxProxyServlet.noOperationOnBean", new Object[]{operation, Integer.valueOf(paramCount), onameStr, info.getClassName()}));
