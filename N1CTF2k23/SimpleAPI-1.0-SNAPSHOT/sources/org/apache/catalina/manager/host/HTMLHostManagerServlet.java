...
/* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/tomcat-embed-core-9.0.35.jar:org/apache/catalina/manager/host/HTMLHostManagerServlet.class */
        ...
        for (String hostName : sortedHostNames) {
            ...
            if (host != null) {
                ...
                if (host.getState().isAvailable()) {
                    args3[0] = response.encodeURL(request.getContextPath() + "/html/stop?name=" + URLEncoder.encode(hostName, "UTF-8"));
                    args3[1] = hostsStop;
                } else {
                    args3[0] = response.encodeURL(request.getContextPath() + "/html/start?name=" + URLEncoder.encode(hostName, "UTF-8"));
                    args3[1] = hostsStart;
                }
                args3[2] = response.encodeURL(request.getContextPath() + "/html/remove?name=" + URLEncoder.encode(hostName, "UTF-8"));
                args3[3] = hostsRemove;
                args3[4] = hostThis;
