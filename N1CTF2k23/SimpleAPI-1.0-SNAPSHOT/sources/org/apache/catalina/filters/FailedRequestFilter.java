...
/* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/tomcat-embed-core-9.0.35.jar:org/apache/catalina/filters/FailedRequestFilter.class */
public class FailedRequestFilter extends FilterBase {
    ...
    private boolean isGoodRequest(ServletRequest request) {
        request.getParameter(LoggingSystem.NONE);
