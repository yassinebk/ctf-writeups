...
/* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/tomcat-embed-core-9.0.35.jar:org/apache/catalina/authenticator/FormAuthenticator.class */
public class FormAuthenticator extends AuthenticatorBase {
    ...
    protected boolean doAuthenticate(Request request, HttpServletResponse response) throws IOException {
        ...
        if (matchRequest(request)) {
            ...
            return false;
        } else if (checkForCachedAuthentication(request, response, true)) {
            return true;
        } else {
