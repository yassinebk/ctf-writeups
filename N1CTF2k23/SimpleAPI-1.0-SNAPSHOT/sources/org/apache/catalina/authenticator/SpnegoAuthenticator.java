...
/* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/tomcat-embed-core-9.0.35.jar:org/apache/catalina/authenticator/SpnegoAuthenticator.class */
public class SpnegoAuthenticator extends AuthenticatorBase {
        ...
        try {
            try {
                try {
                    ...
                    if (this.log.isDebugEnabled()) {
                        this.log.debug(sm.getString("spnegoAuthenticator.ticketValidateFail"), e7);
                    }
                    response.setHeader("WWW-Authenticate", AUTH_HEADER_VALUE_NEGOTIATE);
                    response.sendError(401);
                    if (0 != 0) {
                ...
                this.log.error(sm.getString("spnegoAuthenticator.serviceLoginFail"), e10);
    ...
    /* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/tomcat-embed-core-9.0.35.jar:org/apache/catalina/authenticator/SpnegoAuthenticator$AcceptAction.class */
    ...
    /* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/tomcat-embed-core-9.0.35.jar:org/apache/catalina/authenticator/SpnegoAuthenticator$AuthenticateAction.class */
    ...
    /* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/tomcat-embed-core-9.0.35.jar:org/apache/catalina/authenticator/SpnegoAuthenticator$SpnegoTokenFixer.class */
