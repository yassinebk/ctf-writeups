...
/* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/tomcat-embed-core-9.0.35.jar:org/apache/catalina/realm/RealmBase.class */
public abstract class RealmBase extends LifecycleMBeanBase implements Realm {
    ...
    public Principal authenticate(X509Certificate[] certs) {
        ...
        if (this.validate) {
            for (X509Certificate cert : certs) {
                if (log.isDebugEnabled()) {
                    log.debug(" Checking validity for '" + cert.getSubjectDN().getName() + "'");
                }
                try {
                    cert.checkValidity();
                } catch (Exception e) {
    ...
    /* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/tomcat-embed-core-9.0.35.jar:org/apache/catalina/realm/RealmBase$AllRolesMode.class */
