...
/* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/tomcat-embed-core-9.0.35.jar:org/apache/catalina/realm/JNDIRealm.class */
public class JNDIRealm extends RealmBase {
        ...
        if (getRoleNested()) {
            ...
            loop3: while (true) {
                ...
                for (Map.Entry<String, String> group : newGroups.entrySet()) {
                    String filter2 = this.roleFormat.format(new String[]{doRFC2254Encoding(group.getKey()), group.getValue(), group.getValue()});
                    if (this.containerLog.isTraceEnabled()) {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    /* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/tomcat-embed-core-9.0.35.jar:org/apache/catalina/realm/JNDIRealm$User.class */
