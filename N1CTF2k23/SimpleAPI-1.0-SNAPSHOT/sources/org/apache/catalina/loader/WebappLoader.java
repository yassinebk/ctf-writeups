...
/* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/tomcat-embed-core-9.0.35.jar:org/apache/catalina/loader/WebappLoader.class */
    ...
    private boolean buildClassPath(StringBuilder classpath, ClassLoader loader) {
        ...
        if (!(loader instanceof URLClassLoader)) {
            if (loader == ClassLoader.getSystemClassLoader()) {
                ...
                return false;
            } else if (!JreCompat.isGraalAvailable()) {
