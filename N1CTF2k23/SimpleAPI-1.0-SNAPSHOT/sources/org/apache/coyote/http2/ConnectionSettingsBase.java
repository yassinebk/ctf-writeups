...
/* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/tomcat-embed-core-9.0.35.jar:org/apache/coyote/http2/ConnectionSettingsBase.class */
abstract class ConnectionSettingsBase<T extends Throwable> {
    ...
    public ConnectionSettingsBase(String connectionId) {
        ...
        this.current.put(Setting.MAX_HEADER_LIST_SIZE, Long.valueOf((long) DEFAULT_MAX_HEADER_LIST_SIZE));
    }
