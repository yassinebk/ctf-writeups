...
/* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/tomcat-embed-core-9.0.35.jar:org/apache/coyote/http2/HpackEncoder.class */
public class HpackEncoder {
    ...
    private static final HpackHeaderFunction DEFAULT_HEADER_FUNCTION = new HpackHeaderFunction() { // from class: org.apache.coyote.http2.HpackEncoder.1
        ...
        public boolean shouldUseIndexing(String headerName, String value) {
            return (headerName.equals("content-length") || headerName.equals("date")) ? false : true;
        }
    ...
    /* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/tomcat-embed-core-9.0.35.jar:org/apache/coyote/http2/HpackEncoder$HpackHeaderFunction.class */
    ...
    /* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/tomcat-embed-core-9.0.35.jar:org/apache/coyote/http2/HpackEncoder$State.class */
    enum State {
        COMPLETE,
        UNDERFLOW
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/tomcat-embed-core-9.0.35.jar:org/apache/coyote/http2/HpackEncoder$TableEntry.class */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/tomcat-embed-core-9.0.35.jar:org/apache/coyote/http2/HpackEncoder$DynamicTableEntry.class */
