...
/* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/log4j-api-2.13.2.jar:org/apache/logging/log4j/message/MapMessageJsonFormatter.class */
enum MapMessageJsonFormatter {
    ...
    public static void format(StringBuilder sb, Object object) {
        format(sb, object, 0);
    }
