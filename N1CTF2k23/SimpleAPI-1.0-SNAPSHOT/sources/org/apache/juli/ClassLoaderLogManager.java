...
/* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/tomcat-embed-core-9.0.35.jar:org/apache/juli/ClassLoaderLogManager.class */
public class ClassLoaderLogManager extends LogManager {
    ...
    protected static final ThreadLocal<String> prefix;
    ...
    /* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/tomcat-embed-core-9.0.35.jar:org/apache/juli/ClassLoaderLogManager$Cleaner.class */
    ...
    public String getProperty(String name) {
        ...
        String prefix2 = prefix.get();
        String result = null;
        if (prefix2 != null) {
            result = findProperty(prefix2 + name);
        }
        if (result == null) {
                ...
                while (tok.hasMoreTokens()) {
                    ...
                    if (handlerClassName.length() > 0) {
                        if (Character.isDigit(handlerClassName.charAt(0)) && (pos = handlerClassName.indexOf(46)) >= 0) {
                            prefix2 = handlerClassName.substring(0, pos + 1);
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    /* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/tomcat-embed-core-9.0.35.jar:org/apache/juli/ClassLoaderLogManager$LogNode.class */
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    /* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/tomcat-embed-core-9.0.35.jar:org/apache/juli/ClassLoaderLogManager$ClassLoaderLogInfo.class */
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    /* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/tomcat-embed-core-9.0.35.jar:org/apache/juli/ClassLoaderLogManager$RootLogger.class */
