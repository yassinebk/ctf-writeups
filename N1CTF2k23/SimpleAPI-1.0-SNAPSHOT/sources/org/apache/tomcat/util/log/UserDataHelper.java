...
/* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/tomcat-embed-core-9.0.35.jar:org/apache/tomcat/util/log/UserDataHelper.class */
public class UserDataHelper {
    ...
    /* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/tomcat-embed-core-9.0.35.jar:org/apache/tomcat/util/log/UserDataHelper$Config.class */
    private enum Config {
        NONE,
        DEBUG_ALL,
        INFO_THEN_DEBUG,
    ...
    /* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/tomcat-embed-core-9.0.35.jar:org/apache/tomcat/util/log/UserDataHelper$Mode.class */
    public enum Mode {
        DEBUG,
        INFO_THEN_DEBUG,
        INFO
