...
/* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/tomcat-embed-core-9.0.35.jar:org/apache/tomcat/util/collections/ManagedConcurrentWeakHashMap.class */
public class ManagedConcurrentWeakHashMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
    ...
    /* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/tomcat-embed-core-9.0.35.jar:org/apache/tomcat/util/collections/ManagedConcurrentWeakHashMap$Key.class */
                ...
                return new Iterator<Map.Entry<K, V>>() { // from class: org.apache.tomcat.util.collections.ManagedConcurrentWeakHashMap.1.1
                    ...
                    public Map.Entry<K, V> next() {
                        return new Map.Entry<K, V>() { // from class: org.apache.tomcat.util.collections.ManagedConcurrentWeakHashMap.1.1.1
                            ...
                            {
                                this.en = (Map.Entry) C00021.this.it.next();
                            }
