...
/* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/tomcat-embed-core-9.0.35.jar:org/apache/tomcat/util/net/SSLHostConfig.class */
public class SSLHostConfig implements Serializable {
    ...
    /* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/tomcat-embed-core-9.0.35.jar:org/apache/tomcat/util/net/SSLHostConfig$Type.class */
    public enum Type {
        JSSE,
        OPENSSL
    }
    ...
    /* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/tomcat-embed-core-9.0.35.jar:org/apache/tomcat/util/net/SSLHostConfig$CertificateVerification.class */
    public enum CertificateVerification {
        ...
        public static CertificateVerification fromString(String value) {
            ...
            if ("false".equalsIgnoreCase(value) || "no".equalsIgnoreCase(value) || LoggingSystem.NONE.equalsIgnoreCase(value)) {
                return NONE;
            }
