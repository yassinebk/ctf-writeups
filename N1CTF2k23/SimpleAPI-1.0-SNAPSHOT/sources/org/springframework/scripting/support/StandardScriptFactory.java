...
/* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/spring-context-5.2.6.RELEASE.jar:org/springframework/scripting/support/StandardScriptFactory.class */
    ...
    public Object getScriptedObject(ScriptSource scriptSource, @Nullable Class<?>... actualInterfaces) throws IOException, ScriptCompilationException {
        ...
        if (!ObjectUtils.isEmpty((Object[]) actualInterfaces)) {
            ...
            for (Class<?> requestedIfc : actualInterfaces) {
                ...
                } else if (!requestedIfc.isAssignableFrom((Class) script)) {
                    adaptationRequired = true;
                    break;
                }
            }
