...
/* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/spring-web-5.2.6.RELEASE.jar:org/springframework/web/util/UrlPathHelper.class */
public class UrlPathHelper {
    ...
    public String getLookupPathForRequest(HttpServletRequest request, @Nullable String lookupPathAttributeName) {
        String result;
        if (lookupPathAttributeName != null && (result = (String) request.getAttribute(lookupPathAttributeName)) != null) {
            return result;
        }
