...
/* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/spring-webmvc-5.2.6.RELEASE.jar:org/springframework/web/servlet/mvc/method/RequestMappingInfo.class */
public final class RequestMappingInfo implements RequestCondition<RequestMappingInfo> {
    ...
    /* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/spring-webmvc-5.2.6.RELEASE.jar:org/springframework/web/servlet/mvc/method/RequestMappingInfo$Builder.class */
    ...
    public RequestMappingInfo getMatchingCondition(HttpServletRequest request) {
        ...
        if (methods == null || (params = this.paramsCondition.getMatchingCondition(request)) == null || (headers = this.headersCondition.getMatchingCondition(request)) == null || (consumes = this.consumesCondition.getMatchingCondition(request)) == null || (produces = this.producesCondition.getMatchingCondition(request)) == null || (patterns = this.patternsCondition.getMatchingCondition(request)) == null || (custom = this.customConditionHolder.getMatchingCondition(request)) == null) {
            return null;
        }
    ...
    public String toString() {
        ...
        if (!this.patternsCondition.isEmpty()) {
            ...
            builder.append(" ").append((Object) (patterns.size() == 1 ? patterns.iterator().next() : patterns));
        }
    ...
    /* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/spring-webmvc-5.2.6.RELEASE.jar:org/springframework/web/servlet/mvc/method/RequestMappingInfo$DefaultBuilder.class */
    ...
    /* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/spring-webmvc-5.2.6.RELEASE.jar:org/springframework/web/servlet/mvc/method/RequestMappingInfo$BuilderConfiguration.class */
