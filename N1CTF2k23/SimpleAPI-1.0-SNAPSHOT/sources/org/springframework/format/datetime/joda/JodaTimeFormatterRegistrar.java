...
/* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/spring-context-5.2.6.RELEASE.jar:org/springframework/format/datetime/joda/JodaTimeFormatterRegistrar.class */
public class JodaTimeFormatterRegistrar implements FormatterRegistrar {
    ...
    /* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/spring-context-5.2.6.RELEASE.jar:org/springframework/format/datetime/joda/JodaTimeFormatterRegistrar$Type.class */
    public enum Type {
        DATE,
        TIME,
        DATE_TIME
