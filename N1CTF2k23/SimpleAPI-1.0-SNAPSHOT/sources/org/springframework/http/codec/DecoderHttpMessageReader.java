...
/* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/spring-web-5.2.6.RELEASE.jar:org/springframework/http/codec/DecoderHttpMessageReader.class */
public class DecoderHttpMessageReader<T> implements HttpMessageReader<T> {
    ...
    public Flux<T> read(ResolvableType elementType, ReactiveHttpInputMessage message, Map<String, Object> hints) {
        ...
        return this.decoder.decode((Publisher<DataBuffer>) message.getBody(), elementType, (MimeType) contentType, hints);
    }
