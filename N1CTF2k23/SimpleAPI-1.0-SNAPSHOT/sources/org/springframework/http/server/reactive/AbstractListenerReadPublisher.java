...
/* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/spring-web-5.2.6.RELEASE.jar:org/springframework/http/server/reactive/AbstractListenerReadPublisher.class */
public abstract class AbstractListenerReadPublisher<T> implements Publisher<T> {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void handleCompletionOrErrorBeforeDemand() {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/spring-web-5.2.6.RELEASE.jar:org/springframework/http/server/reactive/AbstractListenerReadPublisher$ReadSubscription.class */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/spring-web-5.2.6.RELEASE.jar:org/springframework/http/server/reactive/AbstractListenerReadPublisher$State.class */
    public enum State {
