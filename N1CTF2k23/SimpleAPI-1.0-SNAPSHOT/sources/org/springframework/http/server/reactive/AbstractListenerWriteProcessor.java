...
/* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/spring-web-5.2.6.RELEASE.jar:org/springframework/http/server/reactive/AbstractListenerWriteProcessor.class */
public abstract class AbstractListenerWriteProcessor<T> implements Processor<T, Void> {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/spring-web-5.2.6.RELEASE.jar:org/springframework/http/server/reactive/AbstractListenerWriteProcessor$State.class */
    public enum State {
        ...
        RECEIVED { // from class: org.springframework.http.server.reactive.AbstractListenerWriteProcessor.State.3
            ...
            public <T> void onComplete(AbstractListenerWriteProcessor<T> processor) {
                ...
                if (((State) ((AbstractListenerWriteProcessor) processor).state.get()).equals(State.REQUESTED)) {
