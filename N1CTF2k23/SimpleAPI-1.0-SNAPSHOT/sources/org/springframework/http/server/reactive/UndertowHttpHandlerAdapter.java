...
/* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/spring-web-5.2.6.RELEASE.jar:org/springframework/http/server/reactive/UndertowHttpHandlerAdapter.class */
public class UndertowHttpHandlerAdapter implements io.undertow.server.HttpHandler {
    ...
    /* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/spring-web-5.2.6.RELEASE.jar:org/springframework/http/server/reactive/UndertowHttpHandlerAdapter$HandlerResultSubscriber.class */
