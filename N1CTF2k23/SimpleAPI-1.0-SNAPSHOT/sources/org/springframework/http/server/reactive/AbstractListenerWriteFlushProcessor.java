...
/* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/spring-web-5.2.6.RELEASE.jar:org/springframework/http/server/reactive/AbstractListenerWriteFlushProcessor.class */
public abstract class AbstractListenerWriteFlushProcessor<T> implements Processor<Publisher<? extends T>, Void> {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/spring-web-5.2.6.RELEASE.jar:org/springframework/http/server/reactive/AbstractListenerWriteFlushProcessor$State.class */
    public enum State {
        ...
        RECEIVED { // from class: org.springframework.http.server.reactive.AbstractListenerWriteFlushProcessor.State.3
            ...
            public <T> void onComplete(AbstractListenerWriteFlushProcessor<T> processor) {
                ...
                if (((State) ((AbstractListenerWriteFlushProcessor) processor).state.get()).equals(State.REQUESTED)) {
                    handleSubscriberCompleted(processor);
                }
            }
        ...
        /* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/spring-web-5.2.6.RELEASE.jar:org/springframework/http/server/reactive/AbstractListenerWriteFlushProcessor$State$WriteResultSubscriber.class */
