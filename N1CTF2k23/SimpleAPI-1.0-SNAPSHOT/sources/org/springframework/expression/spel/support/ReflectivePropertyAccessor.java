...
/* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/spring-expression-5.2.6.RELEASE.jar:org/springframework/expression/spel/support/ReflectivePropertyAccessor.class */
public class ReflectivePropertyAccessor implements PropertyAccessor {
    ...
    public boolean canRead(EvaluationContext context, @Nullable Object target, String name) throws AccessException {
        ...
        if (method != null) {
            ...
            this.readerCache.put(cacheKey, new InvokerPair(ClassUtils.getInterfaceMethodIfPossible(method), typeDescriptor));
    ...
    public boolean canWrite(EvaluationContext context, @Nullable Object target, String name) throws AccessException {
        ...
        if (method != null) {
            ...
            TypeDescriptor typeDescriptor = new TypeDescriptor(property);
            this.writerCache.put(cacheKey, ClassUtils.getInterfaceMethodIfPossible(method));
            this.typeDescriptorCache.put(cacheKey, typeDescriptor);
            return true;
        }
        Field field = findField(name, type, target);
    ...
    /* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/spring-expression-5.2.6.RELEASE.jar:org/springframework/expression/spel/support/ReflectivePropertyAccessor$InvokerPair.class */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/spring-expression-5.2.6.RELEASE.jar:org/springframework/expression/spel/support/ReflectivePropertyAccessor$PropertyCacheKey.class */
    ...
    /* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/spring-expression-5.2.6.RELEASE.jar:org/springframework/expression/spel/support/ReflectivePropertyAccessor$OptimalPropertyAccessor.class */
