...
/* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/spring-expression-5.2.6.RELEASE.jar:org/springframework/expression/spel/standard/InternalSpelExpressionParser.class */
        ...
        while (true) {
            ...
            if (peekToken(TokenKind.STAR, TokenKind.DIV, TokenKind.MOD)) {
                ...
                if (t.kind == TokenKind.STAR) {
                    eatPowerIncDecExpression = new OpMultiply(t.startPos, t.endPos, expr, rhExpr);
                } else if (t.kind == TokenKind.DIV) {
                    eatPowerIncDecExpression = new OpDivide(t.startPos, t.endPos, expr, rhExpr);
                } else {
                    Assert.isTrue(t.kind == TokenKind.MOD, "Mod token expected");
                    eatPowerIncDecExpression = new OpModulus(t.startPos, t.endPos, expr, rhExpr);
                }
            } else {
                return expr;
            }
