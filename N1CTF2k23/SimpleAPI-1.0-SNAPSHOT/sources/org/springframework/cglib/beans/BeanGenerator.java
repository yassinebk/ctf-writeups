...
/* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/spring-core-5.2.6.RELEASE.jar:org/springframework/cglib/beans/BeanGenerator.class */
public class BeanGenerator extends AbstractClassGenerator {
    ...
    /* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/spring-core-5.2.6.RELEASE.jar:org/springframework/cglib/beans/BeanGenerator$BeanGeneratorKey.class */
    ...
    public void generateClass(ClassVisitor v) throws Exception {
        ...
        ce.begin_class(52, 1, getClassName(), this.superclass != null ? Type.getType(this.superclass) : Constants.TYPE_OBJECT, null, null);
