...
/* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/spring-core-5.2.6.RELEASE.jar:org/springframework/cglib/reflect/ConstructorDelegate.class */
public abstract class ConstructorDelegate {
    ...
    /* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/spring-core-5.2.6.RELEASE.jar:org/springframework/cglib/reflect/ConstructorDelegate$ConstructorKey.class */
    ...
    /* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/spring-core-5.2.6.RELEASE.jar:org/springframework/cglib/reflect/ConstructorDelegate$Generator.class */
    public static class Generator extends AbstractClassGenerator {
        ...
        public void generateClass(ClassVisitor v) {
            ...
            try {
                ...
                ce.begin_class(52, 1, getClassName(), CONSTRUCTOR_DELEGATE, new Type[]{Type.getType(this.iface)}, Constants.SOURCE_FILE);
