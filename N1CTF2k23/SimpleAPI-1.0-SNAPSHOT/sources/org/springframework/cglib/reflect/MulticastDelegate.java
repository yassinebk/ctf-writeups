...
/* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/spring-core-5.2.6.RELEASE.jar:org/springframework/cglib/reflect/MulticastDelegate.class */
public abstract class MulticastDelegate implements Cloneable {
    ...
    /* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/spring-core-5.2.6.RELEASE.jar:org/springframework/cglib/reflect/MulticastDelegate$Generator.class */
    public static class Generator extends AbstractClassGenerator {
        ...
        public void generateClass(ClassVisitor cv) {
            ...
            ce.begin_class(52, 1, getClassName(), MULTICAST_DELEGATE, new Type[]{Type.getType(this.iface)}, Constants.SOURCE_FILE);
