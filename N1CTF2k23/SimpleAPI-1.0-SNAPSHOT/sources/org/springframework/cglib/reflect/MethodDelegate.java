...
/* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/spring-core-5.2.6.RELEASE.jar:org/springframework/cglib/reflect/MethodDelegate.class */
public abstract class MethodDelegate {
    ...
    /* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/spring-core-5.2.6.RELEASE.jar:org/springframework/cglib/reflect/MethodDelegate$MethodDelegateKey.class */
    ...
    /* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/spring-core-5.2.6.RELEASE.jar:org/springframework/cglib/reflect/MethodDelegate$Generator.class */
    public static class Generator extends AbstractClassGenerator {
        ...
        public void generateClass(ClassVisitor v) throws NoSuchMethodException {
            ...
            ce.begin_class(52, 1, getClassName(), METHOD_DELEGATE, new Type[]{Type.getType(this.iface)}, Constants.SOURCE_FILE);
