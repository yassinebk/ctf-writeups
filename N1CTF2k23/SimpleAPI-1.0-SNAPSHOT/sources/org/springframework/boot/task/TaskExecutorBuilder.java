...
/* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/spring-boot-2.3.0.RELEASE.jar:org/springframework/boot/task/TaskExecutorBuilder.class */
public class TaskExecutorBuilder {
    ...
    public <T extends ThreadPoolTaskExecutor> T configure(T taskExecutor) {
        ...
        PropertyMapper.Source<Integer> asInt2 = map.from((PropertyMapper) this.awaitTerminationPeriod).asInt((v0) -> {
            return v0.getSeconds();
        });
        taskExecutor.getClass();
        asInt2.to((v1) -> {
        ...
        taskExecutor.getClass();
        from6.to(this::setTaskDecorator);
