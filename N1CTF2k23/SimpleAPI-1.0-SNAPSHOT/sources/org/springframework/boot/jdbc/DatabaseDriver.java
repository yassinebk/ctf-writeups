...
/* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/spring-boot-2.3.0.RELEASE.jar:org/springframework/boot/jdbc/DatabaseDriver.class */
public enum DatabaseDriver {
    ...
    TESTCONTAINERS(null, "org.testcontainers.jdbc.ContainerDatabaseDriver") { // from class: org.springframework.boot.jdbc.DatabaseDriver.8
        @Override // org.springframework.boot.jdbc.DatabaseDriver
        protected Collection<String> getUrlPrefixes() {
