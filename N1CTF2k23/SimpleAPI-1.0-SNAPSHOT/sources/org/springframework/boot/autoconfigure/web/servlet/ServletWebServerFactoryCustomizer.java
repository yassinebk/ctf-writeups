...
/* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/spring-boot-autoconfigure-2.3.0.RELEASE.jar:org/springframework/boot/autoconfigure/web/servlet/ServletWebServerFactoryCustomizer.class */
public class ServletWebServerFactoryCustomizer implements WebServerFactoryCustomizer<ConfigurableServletWebServerFactory>, Ordered {
    ...
    public void customize(ConfigurableServletWebServerFactory factory) {
        ...
        servlet3.getClass();
        PropertyMapper.Source from5 = map.from(this::isRegisterDefaultServlet);
        factory.getClass();
        from5.to((v1) -> {
        ...
        servlet4.getClass();
        PropertyMapper.Source from6 = map.from(this::getSession);
        factory.getClass();
        from6.to(this::setSession);
        ServerProperties serverProperties3 = this.serverProperties;
        serverProperties3.getClass();
        PropertyMapper.Source from7 = map.from(this::getSsl);
        factory.getClass();
        from7.to(this::setSsl);
        ServerProperties.Servlet servlet5 = this.serverProperties.getServlet();
        servlet5.getClass();
        PropertyMapper.Source from8 = map.from(this::getJsp);
        factory.getClass();
        from8.to(this::setJsp);
        ServerProperties serverProperties4 = this.serverProperties;
        serverProperties4.getClass();
        PropertyMapper.Source from9 = map.from(this::getCompression);
        factory.getClass();
        from9.to(this::setCompression);
        ServerProperties serverProperties5 = this.serverProperties;
        serverProperties5.getClass();
        PropertyMapper.Source from10 = map.from(this::getHttp2);
        factory.getClass();
        from10.to(this::setHttp2);
        ServerProperties serverProperties6 = this.serverProperties;
        serverProperties6.getClass();
        PropertyMapper.Source from11 = map.from(this::getServerHeader);
        factory.getClass();
        from11.to(this::setServerHeader);
        ServerProperties.Servlet servlet6 = this.serverProperties.getServlet();
        servlet6.getClass();
        PropertyMapper.Source from12 = map.from(this::getContextParameters);
        factory.getClass();
        from12.to(this::setInitParameters);
        PropertyMapper.Source from13 = map.from((PropertyMapper) this.serverProperties.getShutdown());
        factory.getClass();
        from13.to(this::setShutdown);
    }
}
