...
/* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/spring-boot-autoconfigure-2.3.0.RELEASE.jar:org/springframework/boot/autoconfigure/orm/jpa/HibernateProperties.class */
public class HibernateProperties {
    ...
    private Map<String, Object> getAdditionalProperties(Map<String, String> existing, HibernateSettings settings) {
        ...
        if (StringUtils.hasText(ddlAuto) && !LoggingSystem.NONE.equals(ddlAuto)) {
    ...
    /* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/spring-boot-autoconfigure-2.3.0.RELEASE.jar:org/springframework/boot/autoconfigure/orm/jpa/HibernateProperties$Naming.class */
