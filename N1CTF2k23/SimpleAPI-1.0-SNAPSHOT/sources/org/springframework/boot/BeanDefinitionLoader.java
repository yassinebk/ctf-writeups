...
/* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/spring-boot-2.3.0.RELEASE.jar:org/springframework/boot/BeanDefinitionLoader.class */
public class BeanDefinitionLoader {
    ...
    @FunctionalInterface
    /* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/spring-boot-2.3.0.RELEASE.jar:org/springframework/boot/BeanDefinitionLoader$GroovyBeanDefinitionSource.class */
    ...
    private boolean isComponent(Class<?> type) {
        ...
        return (type.getName().matches(".*\\$_.*closure.*") || type.isAnonymousClass() || type.getConstructors() == null || type.getConstructors().length == 0) ? false : true;
    }

    /* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/spring-boot-2.3.0.RELEASE.jar:org/springframework/boot/BeanDefinitionLoader$ClassExcludeFilter.class */
