...
/* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/spring-boot-2.3.0.RELEASE.jar:org/springframework/boot/SpringApplicationExtensionsKt.class */
public final class SpringApplicationExtensionsKt {
    @NotNull
    public static final /* synthetic */ <T> ConfigurableApplicationContext runApplication(@NotNull String... args) {
    ...
    @NotNull
    public static final /* synthetic */ <T> ConfigurableApplicationContext runApplication(@NotNull String[] args, @NotNull Function1<? super SpringApplication, Unit> function1) {
        Intrinsics.checkParameterIsNotNull(args, "args");
