...
/* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/spring-beans-5.2.6.RELEASE.jar:org/springframework/beans/factory/support/DisposableBeanAdapter.class */
public class DisposableBeanAdapter implements DisposableBean, Runnable, Serializable {
    ...
    private void invokeCustomDestroyMethod(Method destroyMethod) {
        ...
        try {
            ...
            logger.warn("Failed to invoke destroy method '" + this.destroyMethodName + "' on bean with name '" + this.beanName + "'", ex2);
        }
    }
