...
/* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/spring-core-5.2.6.RELEASE.jar:org/springframework/asm/ClassReader.class */
public class ClassReader {
    ...
    public ClassReader(byte[] classFileBuffer, int classFileOffset, boolean checkClassVersion) {
        ...
        if (checkClassVersion && readShort(classFileOffset + 6) > 59) {
    ...
    public void accept(ClassVisitor classVisitor, Attribute[] attributePrototypes, int parsingOptions) {
        ...
        for (int i2 = readUnsignedShort(currentAttributeOffset - 2); i2 > 0; i2--) {
            ...
            if ("SourceFile".equals(attributeName)) {
                ...
                permittedSubtypesOffset = currentAttributeOffset2;
        ...
        if (permittedSubtypesOffset != 0) {
            ...
            while (true) {
                int i12 = numberOfPermittedSubtypes;
                numberOfPermittedSubtypes--;
                if (i12 <= 0) {
                    break;
                }
    ...
    private int readRecordComponent(ClassVisitor classVisitor, Context context, int recordComponentOffset) {
        ...
        if (runtimeVisibleAnnotationsOffset != 0) {
            ...
            while (true) {
                ...
                String annotationDescriptor = readUTF8(currentAnnotationOffset, charBuffer);
                i2 = readElementValues(recordComponentVisitor.visitAnnotationExperimental(annotationDescriptor, true), currentAnnotationOffset + 2, true, charBuffer);
            }
        }
        if (runtimeInvisibleAnnotationsOffset != 0) {
            int numAnnotations2 = readUnsignedShort(runtimeInvisibleAnnotationsOffset);
            ...
            while (true) {
                ...
                String annotationDescriptor2 = readUTF8(currentAnnotationOffset2, charBuffer);
                i4 = readElementValues(recordComponentVisitor.visitAnnotationExperimental(annotationDescriptor2, false), currentAnnotationOffset2 + 2, true, charBuffer);
            }
        }
        if (runtimeVisibleTypeAnnotationsOffset != 0) {
            int numAnnotations3 = readUnsignedShort(runtimeVisibleTypeAnnotationsOffset);
            ...
            while (true) {
                ...
                int currentAnnotationOffset4 = readTypeAnnotationTarget(context, currentAnnotationOffset3);
                String annotationDescriptor3 = readUTF8(currentAnnotationOffset4, charBuffer);
                i6 = readElementValues(recordComponentVisitor.visitTypeAnnotationExperimental(context.currentTypeAnnotationTarget, context.currentTypeAnnotationTargetPath, annotationDescriptor3, true), currentAnnotationOffset4 + 2, true, charBuffer);
            }
        }
        if (runtimeInvisibleTypeAnnotationsOffset != 0) {
            int numAnnotations4 = readUnsignedShort(runtimeInvisibleTypeAnnotationsOffset);
            ...
            while (true) {
                ...
                int currentAnnotationOffset6 = readTypeAnnotationTarget(context, currentAnnotationOffset5);
                String annotationDescriptor4 = readUTF8(currentAnnotationOffset6, charBuffer);
                i8 = readElementValues(recordComponentVisitor.visitTypeAnnotationExperimental(context.currentTypeAnnotationTarget, context.currentTypeAnnotationTargetPath, annotationDescriptor4, false), currentAnnotationOffset6 + 2, true, charBuffer);
            }
        }
        while (attributes != null) {
            Attribute nextAttribute = attributes.nextAttribute;
