...
/* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/gson-2.10.1.jar:com/google/gson/stream/JsonReader.class */
public class JsonReader implements Closeable {
    ...
    private int peekKeyword() throws IOException {
        ...
        if (c == 't' || c == 'T') {
            ...
            keyword = BeanDefinitionParserDelegate.NULL_ELEMENT;
            ...
            if (c == '\n') {
                ...
                if (c == '/') {
                    ...
                    switch (peek) {
                        case '*':
                            this.pos++;
                            if (!skipTo(ResourceUtils.WAR_URL_SEPARATOR)) {
