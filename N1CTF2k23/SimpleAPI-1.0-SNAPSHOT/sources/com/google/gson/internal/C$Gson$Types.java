...
/* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/gson-2.10.1.jar:com/google/gson/internal/$Gson$Types.class */
public final class C$Gson$Types {
    ...
    public static Class<?> getRawType(Type type) {
        ...
        if (type instanceof ParameterizedType) {
            ...
            String className = type == null ? BeanDefinitionParserDelegate.NULL_ELEMENT : type.getClass().getName();
    ...
    */
    ...
    /* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/gson-2.10.1.jar:com/google/gson/internal/$Gson$Types$ParameterizedTypeImpl.class */
    ...
    /* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/gson-2.10.1.jar:com/google/gson/internal/$Gson$Types$GenericArrayTypeImpl.class */
    ...
    /* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/gson-2.10.1.jar:com/google/gson/internal/$Gson$Types$WildcardTypeImpl.class */
