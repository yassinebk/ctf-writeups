...
@JacksonStdImpl
/* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/jackson-databind-2.11.0.jar:com/fasterxml/jackson/databind/deser/std/StringArrayDeserializer.class */
    ...
    private final String[] handleNonArray(JsonParser p, DeserializationContext ctxt) throws IOException {
        ...
        if (canWrap) {
            if (p.hasToken(JsonToken.VALUE_NULL)) {
                _parseString = (String) this._nullProvider.getNullValue(ctxt);
            } else {
                _parseString = _parseString(p, ctxt);
            }
            String value = _parseString;
