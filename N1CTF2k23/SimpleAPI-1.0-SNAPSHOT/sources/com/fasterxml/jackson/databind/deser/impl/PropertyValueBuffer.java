...
/* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/jackson-databind-2.11.0.jar:com/fasterxml/jackson/databind/deser/impl/PropertyValueBuffer.class */
        ...
        if (this._context.isEnabled(DeserializationFeature.FAIL_ON_NULL_CREATOR_PROPERTIES)) {
            for (int ix4 = 0; ix4 < props.length; ix4++) {
                if (this._creatorParameters[ix4] == null) {
                    ...
                    this._context.reportInputMismatch(prop, "Null value for creator property '%s' (index %d); `DeserializationFeature.FAIL_ON_NULL_FOR_CREATOR_PARAMETERS` enabled", prop.getName(), Integer.valueOf(props[ix4].getCreatorIndex()));
                }
            }
        }
