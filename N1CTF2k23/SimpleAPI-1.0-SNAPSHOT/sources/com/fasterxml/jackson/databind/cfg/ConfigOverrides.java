...
/* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/jackson-databind-2.11.0.jar:com/fasterxml/jackson/databind/cfg/ConfigOverrides.class */
public class ConfigOverrides implements Serializable {
    ...
    public JsonFormat.Value findFormatDefaults(Class<?> type) {
        ...
        if (this._overrides != null && (override = this._overrides.get(type)) != null && (format = override.getFormat()) != null) {
            ...
            return format;
        } else if (this._defaultLeniency == null) {
