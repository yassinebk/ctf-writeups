...
/* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/jackson-databind-2.11.0.jar:com/fasterxml/jackson/databind/introspect/POJOPropertiesCollector.class */
public class POJOPropertiesCollector {
    ...
    protected void _sortProperties(Map<String, POJOPropertyBuilder> props) {
        ...
        if (indexed) {
            ...
            Iterator<Map.Entry<? extends String, ? extends POJOPropertyBuilder>> it2 = all.entrySet().iterator();
            while (it2.hasNext()) {
