...
/* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/logback-classic-1.2.3.jar:ch/qos/logback/classic/gaffer/GafferConfigurator.class */
public class GafferConfigurator implements GroovyObject {
    ...
    */
    ...
    /* compiled from: GafferConfigurator.groovy */
    /* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/logback-classic-1.2.3.jar:ch/qos/logback/classic/gaffer/GafferConfigurator$_run_closure1.class */
    ...
    protected ImportCustomizer importCustomizer() {
        ...
        $getCallSiteArray[49].call(customizer, Constants.SSL_PROTO_ALL, $getCallSiteArray[50].callGetProperty(Level.class), "ALL");
