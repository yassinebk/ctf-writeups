...
/* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/tomcat-embed-websocket-9.0.35.jar:javax/websocket/server/ServerEndpointConfig.class */
public interface ServerEndpointConfig extends EndpointConfig {
    ...
    /* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/tomcat-embed-websocket-9.0.35.jar:javax/websocket/server/ServerEndpointConfig$Builder.class */
    ...
    /* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/tomcat-embed-websocket-9.0.35.jar:javax/websocket/server/ServerEndpointConfig$Configurator.class */
    public static class Configurator {
        ...
        static /* synthetic */ Configurator access$100() {
            return loadDefault();
        }
        ...
        /* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/tomcat-embed-websocket-9.0.35.jar:javax/websocket/server/ServerEndpointConfig$Configurator$PrivilegedLoadDefault.class */
        public static class PrivilegedLoadDefault implements PrivilegedAction<Configurator> {
            ...
            public Configurator run() {
                return Configurator.access$100();
            }
        }
