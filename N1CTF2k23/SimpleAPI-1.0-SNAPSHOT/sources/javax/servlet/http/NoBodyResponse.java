...
/* loaded from: SimpleAPI-1.0-SNAPSHOT.jar:BOOT-INF/lib/tomcat-embed-core-9.0.35.jar:javax/servlet/http/NoBodyResponse.class */
class NoBodyResponse extends HttpServletResponseWrapper {
    ...
    public NoBodyResponse(HttpServletResponse r) {
        super(r);
        this.noBody = new NoBodyOutputStream(this);
    }
