...
class AdminAutomation:
    ...
    def login(self) -> bool:
        ...
        print(f'[{datetime.now()}] Successfully logged in!\r')
        return True
                ...
                if link:
                    try:
                        ...
                        if self.driver.current_url == link:
                            print(f'[{datetime.now()}] Visiting: {self.driver.current_url}\r')
                        else:
                            print(f'[{datetime.now()}] After visiting {link}, got redirect to: {self.driver.current_url}\r')
                    except Exception as ex:
                        '''Timeout or other exception occurred on url.
                        '''
                        print(f'[{datetime.now()}] Error after visiting: {link} (Current URL: {self.driver.current_url}). Error: {ex}\r')
