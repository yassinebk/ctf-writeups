...
contract Ticket {
    ...
    bytes32 private constant PERMIT_TYPEHASH =
        keccak256(
            "Permit(address from,address to,uint256 tokenId,uint256 nonce,uint256 deadline)"
        );
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(
            msg.sender == ticketOwner ||
                isApprovedForAll(ticketOwner, msg.sender),
    ...
    function getApproved(uint256 tokenId) public view returns (address) {
        require(
            ...
            "Ticket: approved query for nonexistent token"
        );
    ...
    function transferFrom(address from, address to, uint256 tokenId) public {
        require(
            ...
            "Ticket: transfer caller is not owner nor approved"
        );
    ...
    function transferWithPermit(
        ...
        // fix: require(signer!=address(0),"It's the null address");
    ...
    function burn(uint256 tokenId) public {
        require(
            msg.sender == owner,
            "Ticket: caller is not owner nor approved"
        );
    ...
    function _transfer(address from, address to, uint256 tokenId) internal {
        require(
            ...
            "Ticket: transfer of token that is not own"
        );
    ...
    function _safeTransfer(
        ...
        require(
            ...
            "Ticket: transfer to non ERC721Receiver implementer"
        );
    }
    ...
    function _isApprovedOrOwner(
        ...
        require(
            _owners[tokenId] != address(0),
            "Ticket: operator query for nonexistent token"
        );
