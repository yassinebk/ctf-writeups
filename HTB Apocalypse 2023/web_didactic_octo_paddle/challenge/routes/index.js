module.exports = (db) => {
    ...
    router.get("/cart", AuthMiddleware, async (req, res) => {
        try {
            ...
            console.log("Products ids, /cart",cart.productIds, JSON.parse(cart.productIds))
    ...
    router.post("/add-to-cart/:item", AuthMiddleware, async (req, res) => {
        ...
        try {
            ...
            if (!cart) {
                ...
                const xCart=await newCart.save();

                console.log('Retrieved cart, Jsonstringied', xCart.productIds,JSON.stringify([item]))
            ...
            const xCart=await db.Carts.update(
                { productIds: JSON.stringify(productIds) },
                { where: { userId: userId } }
            );


            console.log('Retrieved cart, Jsonstringied', xCart,JSON.stringify(productIds))
